 ...
 */
function invict_enqueue_styles()
{
 ...
 */
function invict_enqueue_spa_scripts()
{
	if (is_page_template('vue-search-app-template.php')) {
		...
		wp_localize_script(
			...
			array( // WordPress data to be made available to the Vue app.
				...
				'post_folders' => get_terms(array( // default post categories.
					'taxonomy' => 'folders',
					'hide_empty' => false,
					'fields' => 'names',
				)),
				'post_subfolders' => get_terms(array( // default post categories.
					'taxonomy' => 'subfolders',
					'hide_empty' => false,
					'fields' => 'names',
				)),
